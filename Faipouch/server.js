...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ring { position: absolute; border-radius: 50%; border: 1px solid #0d5f73; top: 0; left: 0; right: 0; bottom: 0; }
  ...
  .hud-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(140px, 1fr)); gap: 12px; width: 100%; max-width: 560px; margin-bottom: 20px; }
  .hud-panel {
  ...
  .controls { display: flex; gap: 12px; width: 100%; max-width: 560px; margin-bottom: 16px; }
  ...
  .transcript {
    width: 100%; max-width: 560px; max-height: 200px; overflow-y: auto;
  ...
  .transcript .ai { color: #7ee8ff; margin-bottom: 10px; display: block; }
...
<div class="controls">
  <select id="voiceSelect">
    <option value="id">Suara Pria ID</option>
    <option value="id-female">Suara Wanita ID</option>
    <option value="en">Suara Inggris</option>
  </select>
  <input type="range" id="rateSlider" min="0" max="50" value="15" step="5" title="Kecepatan bicara">
</div>
